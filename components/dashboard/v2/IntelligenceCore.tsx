...
import {
  type SignalCompassNodeId,
  signalCompassLayout,
} from "./signalCompassLayout";

import type { SignalCompassState } from "./signalCompassState";

import { getCompassDirection } from "./signalCompassDirection";

import { getBeaconResonance } from "./BeaconResonance";
...
const IntelligenceCore = forwardRef<
  HTMLDivElement,
...
>(
  (
    ...
    const direction =
      getCompassDirection(validObservedId);
