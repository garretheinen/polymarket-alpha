    ...
    <Card className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      <div className="px-14 py-12">
        ...
        <div className="mt-6 flex justify-center">
          <h1 className="text-center text-[50px] font-extrabold leading-none tracking-tight text-slate-950">
            {briefing.title}
          </h1>
        </div>
        ...
        <div className="mt-5 flex justify-center">
          <div className="flex flex-wrap items-center justify-center gap-3 text-[15px] font-medium text-slate-500">
